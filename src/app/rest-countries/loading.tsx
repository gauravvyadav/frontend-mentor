...
const Loading = () => {
  return (
    <div className="grid h-auto w-full auto-rows-max  grid-cols-1 gap-16 py-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
      {Array.from({ length: 12 }).map((_, i) => (
        <div
          key={i}
          className="m-auto h-96 min-h-[340px] w-[80%] animate-pulse rounded-md bg-gray-200 shadow-lg shadow-gray-200   dark:bg-[hsl(209_23%_22%)] dark:shadow-gray-800  sm:w-[270px]"
        >
          <div
            role="status"
